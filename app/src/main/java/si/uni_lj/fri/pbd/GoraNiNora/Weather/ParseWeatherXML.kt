...
import si.uni_lj.fri.pbd.GoraNiNora.data.WeatherHour
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                when (eventType) {
                    ...
                    XmlPullParser.END_TAG -> {
                        if (tagname.equals("metData")) {
                            if (obmocje != null) {
                                weatherHour = si.uni_lj.fri.pbd.GoraNiNora.data.WeatherHour(0, date!!, oblacnost, vremenski_pojav, intenzivnost,t_500, t_1000, t_1500, t_2000, t_2500, t_3000, meja_snezenja,w_500, w_1000, w_1500, w_2000, w_2500, w_3000,
                                    obmocje!!
                                )
